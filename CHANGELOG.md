...
- `listLists()`, `listContacts()` and `deleteContact()` methods in ActiveCampaignClient and ActiveCampaignService
- Skip system fields with unresolved placeholders that resolve to empty strings, preventing unnecessary API calls
